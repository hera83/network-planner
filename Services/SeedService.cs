...
public class SeedService
{
    ...
    public async Task SeedAsync()
    {
        ...
        _db.Workloads.AddRange(
            new Workload { Name = "UniFi Controller", Category = "Infrastructure", HostServer = "Proxmox01", VmId = 100, IpAddress = "10.64.20.30", OperatingSystem = "Ubuntu Server", Description = "UniFi network controller" },
            new Workload { Name = "Nginx Proxy Manager", Category = "Infrastructure", HostServer = "Proxmox01", VmId = 700, IpAddress = "10.64.20.40", OperatingSystem = "Debian", Description = "Reverse proxy" },
            new Workload { Name = "AiGateway", Category = "AI Services", HostServer = "Proxmox02", VmId = 500, IpAddress = "10.64.20.80", OperatingSystem = ".NET / Linux", Description = "Gateway til lokale AI services" },
            new Workload { Name = "Ollama", Category = "AI Services", HostServer = "Proxmox02", VmId = 501, IpAddress = "10.64.20.81", OperatingSystem = "Ubuntu Server", Description = "LLM workloads" },
            new Workload { Name = "Speaches", Category = "AI Services", HostServer = "Proxmox02", VmId = 502, IpAddress = "10.64.20.82", OperatingSystem = "Ubuntu Server", Description = "STT/TTS workloads" },
            new Workload { Name = "SQL Server", Category = "Database", HostServer = "Proxmox01", VmId = 400, IpAddress = "10.64.20.70", OperatingSystem = "Windows Server", Description = "Databaseserver" },
            new Workload { Name = "Test Linux", Category = "Lab", HostServer = "Proxmox01", VmId = 900, IpAddress = "10.64.20.200", OperatingSystem = "Ubuntu Server", Description = "Midlertidig testmaskine" }
        );
